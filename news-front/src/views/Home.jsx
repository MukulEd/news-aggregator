              ...
              <div className="whats-news-wrapper">
                        ...
                        >
                          {Object.keys(selectedCategories).map((key) => (
                            <a
                              ...
                              id="nav-home-tab"
                              data-toggle="tab"
                              href={"#" + selectedCategories[key]}
                              role="tab"
                              aria-controls={selectedCategories[key]}
                              aria-selected="true"
                              onClick={() =>
                                onCategoryNews(selectedCategories[key])
                              }
                            >
                    ...
                    <div className="tab-content" id="nav-tabContent">
                      ...
                      >
                        <div className="row">
                          ...
                          <div className="col-xl-6 col-lg-12">
                            <div className="row">
                              {/* {Object.keys(categoryNews.slice(1, 5)).map(
                                (key) => (
                ...
                <div className="button-group-area mt-40">
                  <a
                    ...
                    onClick={() => onSetSelectedCategories("business")}
                    className={
                      selectedCategories.includes("business")
                        ? "primary genric-btn medium"
                        : "primary-border genric-btn medium"
                    }
                  >
                    Business
                  </a>
                  <a
                    href="javascript:void(0)"
                    className={
                      selectedCategories.includes("entertainment")
                        ? "primary genric-btn medium"
                        : "primary-border genric-btn medium"
                    }
                    onClick={() => onSetSelectedCategories("entertainment")}
                  >
                    Entertainment
                  </a>
                  <a
                    href="javascript:void(0)"
                    className={
                      selectedCategories.includes("science")
                        ? "primary genric-btn medium"
                        : "primary-border genric-btn medium"
                    }
                    onClick={() => onSetSelectedCategories("science")}
                  >
                    Science
                  </a>
                  <a
                    ...
                    onClick={() => onSetSelectedCategories("sports")}
                  >
                    Sports
                  </a>
                  <a
                    ...
                    onClick={() => onSetSelectedCategories("technology")}
                  >
                    Technology
                  </a>
                </div>
              ...
              <div className="most-recent-area">
                ...
                <div className="most-recent-single">
                  ...
                  <div className="most-recent-capt">
                    <h4>
                      <a href="#">
                        Most Beautiful Things to Do in Sidney with Your BF
                      </a>
                    </h4>
                ...
                <div className="slider-wrapper">
                  ...
                  <div className="button-group-area mt-40">
                    {Object.keys(sources.slice(0, 26)).map((key) => (
                      <a
                        href="javascript:void(0)"
                        onClick={() => onSourceNews(sources[key].id)}
                        className={
                          selectedSources.includes(sources[key].id)
                            ? "primary genric-btn small"
                            : "primary-border genric-btn small"
                        }
                      >
                        {sources[key].name}
                      </a>
