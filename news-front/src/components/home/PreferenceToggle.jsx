...
import { getArticles, toggleUserView } from "@/features/article/articleSlice";
...
export default function toggle() {
  ...
  const handleCheck = (e) => {
    const isPreferencedView = user.showPersonalizedView;
    dispatch(toggleUserView());
    if (isPreferencedView) {
      dispatch(
        setFilterData({
          sources: [],
          categories: [],
  ...
  useEffect(() => {
    // console.log(user.showPersonalizedView, "user personalized view");
      ...
      <>
        <div className="">
          <div className="w-full px-4 mx-auto ">
            <p className="font-semibold -mb-2 text-sm text-center"> View</p>
            <input
              type="checkbox"
              id="switch_toggle_3"
              checked={user.showPersonalizedView}
              onClick={handleCheck}
            />
            <label
              htmlFor="switch_toggle_3"
              className="mx-auto bg-gray-800 block cursor-pointer relative rounded-2xl shadow-xl"
            >
              <svg
                className="absolute left-[17px] text-purple-600"
                fill="currentColor"
                width={10}
                height={12}
              ...
              <svg
                className="cross_toggle_3 text-purple-600"
                width={10}
                height={12}
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
